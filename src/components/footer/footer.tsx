    ...
    return <div className={styles.container}>
        <div className={styles.content}>
            <div className={styles.item}>
                <img src={logo} />
                <Typography variant="body2" className={styles.body2}>Автоматизированная информационная <br />
                    система «Реестры»</Typography>
                <Typography variant="body2" className={styles.body2}>© АИС «Реестры», 2022.<br />
        ...
        <div className={styles.partners}>
            ...
            <div className={styles.elements}>
                ...
                <Button as="a" href="https://google.com/" variant="link" className={styles.partner}>Условный партнер</Button>
                <Button as="a" href="https://google.com/" variant="link" className={styles.partner}>Условный партнер</Button>
                <Button as="a" href="https://google.com/" variant="link" className={styles.partner}>Условный партнер</Button>
                <Button as="a" href="https://google.com/" variant="link" className={styles.partner}>Условный партнер</Button>
            </div>
